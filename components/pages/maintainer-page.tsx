...
const maintainerProfile = {
  ...
  summary:
    'Building and maintaining the HiAnime API service with a focus on reliability, scraping accuracy, and delightful developer tooling.',
...
const responsibilities = [
  ...
  },
  {
    ...
    description: 'Plans enhancements for new endpoints, proxy improvements, and developer experience upgrades.',
    icon: Target,
  },
  {
    title: 'Community Support',
    description: 'Provides guidance for integrators via GitHub issues and direct contact, including key rotation help.',
    icon: BookOpen,
  },
  {
    title: 'Performance & Scaling',
    description: 'Optimizes scraping routines, caching strategy, and edge proxy rules for faster responses.',
    icon: Zap,
  },
];
        ...
        <article className="flex-1 space-y-8 sm:space-y-10 md:space-y-12">
          ...
          >
            ...
            <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-muted-foreground">
              ...
              <p>
                <span className="font-semibold text-foreground">Focus Areas:</span> Scraping accuracy, streaming
